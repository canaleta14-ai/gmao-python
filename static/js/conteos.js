                ...
                <div class="btn-group btn-group-sm" role="group">
                    ${
                      conteo.estado === "pendiente"
                        ? `<button type="button" class="btn btn-sm btn-outline-success" onclick="mostrarModalProcesarConteo(${conteo.id}, '${conteo.articulo.codigo}', '${conteo.articulo.descripcion}', ${conteo.stock_teorico})" title="Procesar conteo">
                            <i class="bi bi-check-circle"></i>
                        </button>`
                        : `<button type="button" class="btn btn-sm btn-outline-info" onclick="verDetalleConteo(${conteo.id})" title="Ver detalle">
                            <i class="bi bi-eye"></i>
                        </button>`
                    }
                    <button type="button" class="btn btn-sm btn-outline-primary" onclick="editarConteo(${
                      conteo.id
                    })" title="Editar">
                    ...
                    ${
                      conteo.estado === "pendiente"
                        ? `<button type="button" class="btn btn-sm btn-outline-danger" onclick="confirmarEliminarConteo(${conteo.id}, '${conteo.articulo.codigo}')" title="Eliminar conteo">
