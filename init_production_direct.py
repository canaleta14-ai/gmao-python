...
os.environ['GAE_ENV'] = 'standard'  # Simular entorno de producción
...
def init_production_database():
    ...
    print("=== INICIALIZACIÓN DIRECTA DE BASE DE DATOS DE PRODUCCIÓN ===\n")
    
    try:
        # Crear la aplicación con configuración de producción
        print("🏗️ Creando aplicación con configuración de producción...")
        app = create_app()
        ...
        with app.app_context():
            ...
            if admin_existente:
                print("   ⚠️ Usuario admin ya existe, eliminando...")
