#!/usr/bin/env python3
"""
Script simplificado para inicializar la base de datos gmao en Cloud SQL
"""
...
def connect_to_db():
    """Conectar a la base de datos usando configuraciones conocidas"""

    # Configuración de conexión
    db_host = "/cloudsql/mantenimiento-470311:europe-southwest1:gmao-postgres-spain"
    db_name = "gmao"
    db_user = "gmao-user"
    db_password = "admin123"  # Contraseña conocida
...
def main():
    print("=" * 60)
    print("INICIALIZACIÓN SIMPLE DE BASE DE DATOS GMAO")
    print("=" * 60)
